...
public class booksmn extends DataBase {
	...
	public boolean execute(HttpServletRequest res) throws Exception {
		...
		sqlStr = "select  a.Id,a.BookName,a.BookClass,b.ClassName,a.Author,a.Publish,a.BookNo,a.Content,a.Prince,a.Amount,a.Leav_number from My_Book a,My_BookClass b where a.BookClass = b.Id ";
		if (!classid.equals("") ){  
			if (page == 1)
			{
	...
	public boolean insert() throws Exception {
        ...
        sqlStr = "insert into My_Book (BookName,BookClass,Author,Publish,Bookno,Content,Prince,Amount,Leav_number) values ('";
		sqlStr = sqlStr + abooks.getBookName() + "','";
		sqlStr = sqlStr + abooks.getBookClass() + "','";
		sqlStr = sqlStr + abooks.getAuthor() + "','";
		sqlStr = sqlStr + abooks.getPublish() + "','";
		sqlStr = sqlStr + abooks.getBookNo() + "','";
		sqlStr = sqlStr + abooks.getContent() + "','";
	...
	public boolean update() throws Exception {
		...
		sqlStr = sqlStr + "BookName = '" + abooks.getBookName() + "',";
		sqlStr = sqlStr + "BookClass = '" + abooks.getBookClass() + "',";
		sqlStr = sqlStr + "Author = '" + abooks.getAuthor() + "',";
		sqlStr = sqlStr + "Publish = '" + abooks.getPublish() + "',";
		sqlStr = sqlStr + "BookNo = '" + abooks.getBookNo() + "',";
		sqlStr = sqlStr + "Content = '" + abooks.getContent() + "',";
	...
	public boolean getOnebook(int newid ) throws Exception {
		try
		{
			sqlStr="select  a.Id,a.BookName,a.BookClass,b.ClassName,a.Author,a.Publish,a.BookNo,a.Content,a.Prince,a.Amount,a.Leav_number from My_Book a,My_BookClass b where a.BookClass=b.Id and a.Id = " + newid ;
			rs = stmt.executeQuery(sqlStr);
